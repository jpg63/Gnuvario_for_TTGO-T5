...
* bug GPS 50 m de trop                                                                                *
* bug affichage stat                                                                                  *
* Problème I2C MPU                                                                                    *
* Création dynamique des objets screen                                                                *
* Créer une bibliothèque de log (debug)                                                               *
* Ajouter compenssation température et altitude dans variosettings                                    *
*                                                                                                     *
* VX.X                                                                                                *
 ...
 * - Ajout compenssation de température dans fichier SETTINGS.TXT       *
 * - Ajout correction altitude GPS dans SETTINGS.TXT                    *
 * - Ajout desactication/activation BT dans fichier SETTINGS.TXT        *
 *                                                                      *
 ************************************************************************
...
unsigned long lastDisplayTimestamp, time_deep_seep;
...
//    pinMode(0, INPUT_PULLUP);
  ...
  time_deep_seep       = lastDisplayTimestamp;
