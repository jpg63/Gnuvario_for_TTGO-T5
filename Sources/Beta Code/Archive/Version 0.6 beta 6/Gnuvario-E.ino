...
* MODIF - revoir de deep-sleep / ecran en mode hibernate                                              *
* AJOUT - Ajout de plusieurs nom de voile                                                             *                                                      
...
/*    char FileName[15] = "SETTINGS.TXT";
    ...
    GnuSettings.loadConfigurationVario("test.jso");
